...
import { User, Sparkles, Mail, Github, Link as LinkIcon, Camera, X, CheckCircle2 } from 'lucide-react';
...
const skillOptions = [
  'Python', 'R', 'C', 'C++', 'Java', 'Pytorch', 'TensorFlow', 
  'LangChain', 'ML', 'NLP', 'SQL', 'GenAI'
];

// Skill color mapping based on categories
const getSkillColors = (skill: string) => {
  const colorMap: { [key: string]: { bg: string; text: string; selectedBg: string; shadow: string } } = {
    'Python': { 
      bg: 'bg-[#DBEAFE]', 
      text: 'text-[#1E40AF]', 
      selectedBg: 'bg-gradient-to-r from-[#3B82F6] to-[#2563EB]',
      shadow: 'shadow-[#3B82F6]/30'
    },
    'R': { 
      bg: 'bg-[#D1FAE5]', 
      text: 'text-[#065F46]', 
      selectedBg: 'bg-gradient-to-r from-[#10B981] to-[#059669]',
      shadow: 'shadow-[#10B981]/30'
    },
    'C': { 
      bg: 'bg-[#E0E7FF]', 
      text: 'text-[#3730A3]', 
      selectedBg: 'bg-gradient-to-r from-[#6366F1] to-[#4F46E5]',
      shadow: 'shadow-[#6366F1]/30'
    },
    'C++': { 
      bg: 'bg-[#DDD6FE]', 
      text: 'text-[#5B21B6]', 
      selectedBg: 'bg-gradient-to-r from-[#8B5CF6] to-[#7C3AED]',
      shadow: 'shadow-[#8B5CF6]/30'
    },
    'Java': { 
      bg: 'bg-[#FEE2E2]', 
      text: 'text-[#991B1B]', 
      selectedBg: 'bg-gradient-to-r from-[#EF4444] to-[#DC2626]',
      shadow: 'shadow-[#EF4444]/30'
    },
    'Pytorch': { 
      bg: 'bg-[#FCE7F3]', 
      text: 'text-[#9F1239]', 
      selectedBg: 'bg-gradient-to-r from-[#EC4899] to-[#DB2777]',
      shadow: 'shadow-[#EC4899]/30'
    },
    'TensorFlow': { 
      bg: 'bg-[#FED7AA]', 
      text: 'text-[#9A3412]', 
      selectedBg: 'bg-gradient-to-r from-[#F97316] to-[#EA580C]',
      shadow: 'shadow-[#F97316]/30'
    },
    'LangChain': { 
      bg: 'bg-[#FEF3C7]', 
      text: 'text-[#92400E]', 
      selectedBg: 'bg-gradient-to-r from-[#F59E0B] to-[#D97706]',
      shadow: 'shadow-[#F59E0B]/30'
    },
    'ML': { 
      bg: 'bg-[#FBCFE8]', 
      text: 'text-[#831843]', 
      selectedBg: 'bg-gradient-to-r from-[#F472B6] to-[#EC4899]',
      shadow: 'shadow-[#F472B6]/30'
    },
    'NLP': { 
      bg: 'bg-[#E9D5FF]', 
      text: 'text-[#6B21A8]', 
      selectedBg: 'bg-gradient-to-r from-[#A855F7] to-[#9333EA]',
      shadow: 'shadow-[#A855F7]/30'
    },
    'GenAI': { 
      bg: 'bg-[#FAE8FF]', 
      text: 'text-[#701A75]', 
      selectedBg: 'bg-gradient-to-r from-[#C084FC] to-[#A855F7]',
      shadow: 'shadow-[#C084FC]/30'
    },
    'SQL': { 
      bg: 'bg-[#CFFAFE]', 
      text: 'text-[#155E75]', 
      selectedBg: 'bg-gradient-to-r from-[#06B6D4] to-[#0891B2]',
  ...
  return colorMap[skill] || { 
    bg: 'bg-[#F3F3F5]', 
    text: 'text-[#364153]', 
    selectedBg: 'bg-gradient-to-r from-[#6B7280] to-[#4B5563]',
...
export function StudentProfilePage({ onLogout }: StudentProfilePageProps) {
  ...
  const handleSaveBasic = () => {
    if (!name.trim() || !studentId.trim() || !department.trim() || !academicStatus) {
  ...
  const sidebarItems = [
    ...
    { id: 'interests' as Section, label: '관심 분야', icon: Sparkles },
    { id: 'contact' as Section, label: '연락처 정보', icon: Mail }
  ];
        ...
        <div className="flex gap-8 py-12 min-h-[600px]">
          ...
          <div className="w-64 flex-shrink-0">
            <div className="bg-white rounded-xl border border-gray-200 p-4 sticky top-8">
              <h3 className="text-[#1F2937] font-semibold mb-4 px-2">프로필 설정</h3>
          ...
          <div className="flex-1">
            <div className="bg-white rounded-xl border border-gray-200 p-8">
              ...
              {activeSection === 'basic' && (
                <div>
                  <div className="mb-6">
                    <h2 className="text-[#1F2937] font-semibold mb-1">기본 정보</h2>
                    <p className="text-[#6B7280] text-sm">필수 정보를 입력해주세요</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className="block text-[#374151] text-sm font-medium mb-2">
                          학번 <span className="text-[#DC2626]">*</span>
                        </label>
                        <input
                          type="text"
                          value={studentId}
                    ...
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">
                        소속 / 전공 <span className="text-[#DC2626]">*</span>
                      </label>
                      <input
                        type="text"
                        value={department}
                    ...
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">
                        학년 / 학적 상태 <span className="text-[#DC2626]">*</span>
                      </label>
                      <select
              ...
              {activeSection === 'interests' && (
                <div>
                  <div className="mb-6">
                    <h2 className="text-[#1F2937] font-semibold mb-1">관심 분야</h2>
                    <p className="text-[#6B7280] text-sm">나의 경험과 관심사를 작성해주세요</p>
                  </div>

                  <div className="space-y-6">
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">자기소개</label>
                      <p className="text-xs text-[#6B7280] mb-3">경험, 프로젝트, 수강한 과목, 관심 분야 등 자유롭게 기입해주세요</p>
                      <textarea
                        value={introduction}
                    ...
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">스킬 스택</label>
                      <p className="text-xs text-[#6B7280] mb-3">보유하고 있는 기술을 모두 선택하세요</p>
                      ...
                      {selectedSkills.length > 0 && (
                        <div className="mt-4 p-4 bg-[#F9FAFB] rounded-lg border border-[#E5E7EB]">
                          <div className="flex items-center gap-2 mb-3">
                            ...
                            <p className="text-sm text-[#374151] font-medium">선택된 스킬 ({selectedSkills.length}개)</p>
                          </div>
                          <div className="flex flex-wrap gap-2">
              ...
              {activeSection === 'contact' && (
                <div>
                  <div className="mb-6">
                    <h2 className="text-[#1F2937] font-semibold mb-1">연락처 정보</h2>
                    <p className="text-[#6B7280] text-sm">연락 가능한 정보를 입력해주세요</p>
                  </div>

                  <div className="space-y-6">
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">이메일</label>
                    ...
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">GitHub 링크</label>
                      <div className="relative">
                    ...
                    <div>
                      <label className="block text-[#374151] text-sm font-medium mb-2">포트폴리오 링크</label>
                      <div className="relative">
