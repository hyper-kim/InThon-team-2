...
import { Briefcase, Plus, Trash2, Calendar, Users, ArrowLeft, GraduationCap } from 'lucide-react';
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 text-[#364153] hover:text-[#A1121A] transition-colors"
              >
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-[#A1121A] font-[Paperlogy]">모집 공고 관리</span>
            </div>
          </div>
        </PageContainer>
      </div>
        ...
        <div className="py-12">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-12 h-12 bg-gradient-to-br from-[#A1121A] to-[#8A0F16] rounded-xl flex items-center justify-center shadow-lg">
                <Briefcase className="w-6 h-6 text-white" />
              </div>
              <div>
                <h1 className="text-[#101828]">학생 모집 공고 게시판</h1>
                <p className="text-[#4a5565] text-sm">연구실 학생 모집 공고를 작성하고 관리하세요</p>
              </div>
            </div>
          </div>
