  ...
  return (
    <div className="relative bg-[#FBFBF9] pt-20 pb-32 overflow-hidden">
      ...
      <div className="absolute left-[10%] top-20 w-20 h-20 rounded-full bg-white shadow-lg overflow-hidden">
        ...
        />
        <div className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#A1121A]" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%)' }}></div>
      </div>
      ...
      <div className="absolute right-[12%] top-32 w-20 h-20 rounded-full bg-white shadow-lg overflow-hidden">
        <ImageWithFallback 
          ...
          className="w-full h-full object-cover"
        />
        <div className="absolute -top-2 -right-2 w-6 h-6 bg-[#A1121A]" style={{ clipPath: 'polygon(100% 0, 0 0, 100% 100%)' }}></div>
      </div>

      <div className="absolute left-[8%] bottom-32 w-20 h-20 rounded-full bg-white shadow-lg overflow-hidden">
        <ImageWithFallback 
          src="https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400"
          alt="Student"
          className="w-full h-full object-cover"
        />
        <div className="absolute -bottom-2 -left-2 w-6 h-6 bg-[#A1121A]" style={{ clipPath: 'polygon(0 0, 100% 100%, 0 100%)' }}></div>
      </div>

      <div className="absolute right-[10%] bottom-40 w-20 h-20 rounded-full bg-white shadow-lg overflow-hidden">
        <ImageWithFallback 
          src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400"
          alt="Student"
          className="w-full h-full object-cover"
        />
        <div className="absolute -top-2 -left-2 w-8 h-8 bg-[#A1121A]" style={{ clipPath: 'polygon(0 0, 100% 0, 0 100%)' }}></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm mb-8 border border-gray-200">
          ...
          <span className="text-sm text-[#364153]">내 프로필 카드 작성하기</span>
        </div>

        {/* Main heading - 한글 */}
        <h1 className="text-6xl lg:text-7xl mb-6 leading-tight font-[Paperlogy]">
          <span className="text-[#101828]">나에게 맞는 연구실을</span>
          <br />
        ...
        <p className="text-lg md:text-xl text-[#4a5565] max-w-3xl mx-auto mb-10 leading-relaxed">
          KuNnect는 고려대학교 학생들이 최첨단 연구실을 쉽고 친숙하게 탐색할 수 있도록 돕는
          <br />
          AI 기반 안내 플랫폼입니다. 당신에게 가장 잘 맞는 연구실을 찾을 수 있도록 스마트한 인사이트를 제공합니다.
        </p>
      </div>

      {/* Bottom fade */}
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-[#F9FAFB] to-transparent"></div>
    </div>
  );
}
