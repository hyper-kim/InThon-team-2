      ...
      <PageContainer>
        <div className="py-12">
          ...
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-[Paperlogy] mb-2">연구실 관리자 페이지</h1>
            <p className="text-[#4a5565]">이 페이지에서 연구실 기본 정보, 면담 가능 시간, 모집 공고를 수정할 수 있습니다.</p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-6">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-4 flex justify-end">
                <button className="px-6 py-2 bg-[#A1121A] text-white rounded-lg hover:bg-[#8A0F16] transition-colors text-sm font-medium">
                  저장하기
                </button>
              </div>
            </div>
